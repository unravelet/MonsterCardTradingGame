...
//        public SpellCard(Guid id, string owner, string name, int damage, int speed, Card.ElementalType element, Card.Monster monster, bool isSpell, string description) {
//            _id = id;
//            _owner = owner;
//            _elemental = element;
//            _isSpell = true;
